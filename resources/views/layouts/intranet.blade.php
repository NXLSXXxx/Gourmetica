    ...
    <div class="flex min-h-screen relative" x-data="{ open: false }">
        ...
        <aside :class="open ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'" class="w-64 bg-brand-primary border-r border-slate-800 flex flex-col fixed h-full z-[80] transition-transform duration-300 ease-in-out shadow-2xl lg:shadow-none">
            ...
            <nav class="flex-1 mt-6 overflow-y-auto no-scrollbar">
                ...
                <a href="{{ route('intranet.dashboard') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('intranet.dashboard') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                    Dashboard
                </a>
                @endif

                <a href="{{ route('admin.pos.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.pos.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3 text-brand-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
                    <span class="flex-1">Punto de Venta (POS)</span>
                ...
                <a href="{{ route('admin.headquarters.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.headquarters.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    Sedes
                </a>
                @endif

                <a href="{{ route('admin.delivery_zones.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.delivery_zones.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"></path></svg>
                    Zonas de Delivery
                </a>

                @if(!auth('admin')->user()->isCajero())
                <a href="{{ route('admin.products.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.products.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                    Productos
                </a>

                <a href="{{ route('admin.banners.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.banners.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.categories.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.categories.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.orders.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.orders.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
                    Pedidos
                </a>

                <a href="{{ route('admin.catering.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.catering.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.701 2.701 0 00-1.5-.454M9 6v2m3-2v2m3-2v2M9 3h.01M12 3h.01M15 3h.01M21 21v-7a2 2 0 00-2-2H5a2 2 0 00-2 2v7h18zm-3-9v-2a2 2 0 00-2-2H8a2 2 0 00-2 2v2h12z"></path></svg>
                    Catering
                </a>
                @endif

                <a href="{{ route('admin.sales.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.sales.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.purchases.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.purchases.*') ? 'active' : '' }}">
                ...
                @if(auth('admin')->user()->isAdmin())
                <a href="{{ route('admin.clients') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.clients') ? 'active' : '' }}">
                ...
                @if(auth('admin')->user()->isAdmin() || auth('admin')->user()->isIngeniero())
                <a href="{{ route('admin.users.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.settings.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.logs.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.logs.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    Logs del Sistema
                </a>
                <a href="{{ route('admin.backups.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.backups.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.audits.index') }}" class="sidebar-link flex items-center px-6 py-4 transition-all hover:bg-slate-800 {{ request()->routeIs('admin.audits.*') ? 'active' : '' }}">
        ...
        <!-- Main Content -->
        <main class="flex-1 lg:ml-64 min-h-screen bg-brand-dark p-8 mt-16 lg:mt-0">
