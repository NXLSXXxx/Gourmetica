...
@section('title', 'Nuevo Producto | Gourmetica Intranet')
...
<div class="min-h-screen bg-[#0F172A] text-white p-8">
    <div class="max-w-4xl mx-auto">
        <header class="mb-12">
            ...
            <h1 class="text-3xl font-serif font-bold text-brand-secondary">Crear Nuevo Producto</h1>
            <p class="text-slate-400 mt-2">Ingresa los detalles del producto y asigna el stock inicial por sede.</p>
        </header>
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="bg-[#1E293B] p-8 rounded-2xl border border-slate-700 shadow-xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name" required class="w-full bg-slate-800 border border-slate-600 rounded-lg px-4 py-3 text-white focus:border-brand-primary focus:ring-1 focus:ring-brand-primary outline-none transition-all" placeholder="Ej: Croissant de Almendras">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="base_price" required class="w-full bg-slate-800 border border-slate-600 rounded-lg px-4 py-3 text-white focus:border-brand-primary outline-none transition-all" placeholder="0.00">
                    </div>
                    
                    <div class="col-span-2">
                        <label class="block text-sm font-medium text-slate-400 mb-2">Imagen del Producto</label>
                        <div class="flex items-center justify-center w-full">
                            <label class="flex flex-col items-center justify-center w-full h-40 border-2 border-slate-600 border-dashed rounded-xl cursor-pointer bg-slate-800/50 hover:bg-slate-800 transition-all">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="mb-2 text-sm text-slate-400"><span class="font-semibold">Click para subir</span> o arrastra</p>
                                    <p class="text-xs text-slate-500">PNG, JPG o WEBP (Máx. 2MB)</p>
                                </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" rows="4" class="w-full bg-slate-800 border border-slate-600 rounded-lg px-4 py-3 text-white focus:border-brand-primary outline-none transition-all" placeholder="Describe los ingredientes y el sabor..."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-[#1E293B] p-8 rounded-2xl border border-slate-700 shadow-xl space-y-6">
                ...
                <div id="options-container" class="space-y-6">
                    <!-- Dynamic option blocks will be appended here -->
                </div>
